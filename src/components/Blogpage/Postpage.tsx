      ...
      <div className="flex flex-col h-screen">
        <div className="flex flex-col items-start bg-cover md:flex-row bg-gradient-to-b from-black to-purple-500">
          ...
          <div className="flex flex-col items-center w-9/12 h-auto m-auto mb-10 bg-white rounded-lg shadow-lg">
            <h1 className="mt-5 text-5xl text-black"><b>{location.state.Title}</b></h1>
            <div className="w-3/4 mt-5 rounded-lg h-1/5">
              <img src={`data:image/png;base64,${objImg}`} alt={location.state.Title} className="flex w-full h-full bg-center rounded-lg"></img>
            </div>
        ...
        <div className="flex flex-col items-start h-screen bg-cover bg-gradient-to-b from-purple-500 to-white">
        </div>
    </div>
    )
  }
